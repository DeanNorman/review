        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary border border-border">
              ...
              <span className="text-sm text-muted-foreground">Worxit Platform - Complete Workflow Control</span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              {SITE_CONFIG.tagline}
              <span className="block text-gradient">Facilities Management Solutions</span>
            </h1>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-border">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">Multi-Site Operations</span>
              </div>
            </div>
          </div>
